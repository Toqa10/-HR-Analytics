...
st.markdown("<p style='text-align:center; color:gray;'>Interactive dashboard for HR insights and salary analytics</p>", unsafe_allow_html=True)
st.markdown("---")
...
if center_button and question:
    ...
    if question == "top salaries":
        ...
        st.markdown("<p style='text-align:center; color:gray;'>These are the employees with the highest salaries in the company.</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='text-align:center; color:gray;'>This chart shows how salaries evolved over the years.</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='text-align:center; color:gray;'>Employees with the highest percentage increase in salary.</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='text-align:center; color:gray;'>Age distribution of employees in the organization.</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='text-align:center; color:gray;'>Which departments have the highest average salaries?</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='text-align:center; color:gray;'>Relationship between years in company and salary levels.</p>", unsafe_allow_html=True)
        ...
        fig.update_layout(template="plotly_dark", plot_bgcolor="black", paper_bgcolor="black")
        st.markdown("<p style='text-align:center; color:gray;'>Salary spread across different departments.</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='text-align:center; color:gray;'>Number of employees in each department.</p>", unsafe_allow_html=True)
        ...
        st.markdown("<p style='text-align:center; color:gray;'>Most common job titles by different age groups.</p>", unsafe_allow_html=True)
        ...
        fig.update_layout(template="plotly_dark", plot_bgcolor="black", paper_bgcolor="black")
        st.markdown("<p style='text-align:center; color:gray;'>Average salary levels across different job titles.</p>", unsafe_allow_html=True)
